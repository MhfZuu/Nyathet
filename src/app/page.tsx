      ...
      <main className="relative min-h-screen w-full">
        <section className="relative bg-[#E5F5F6] dark:bg-gray-800 min-h-screen px-4 sm:px-6 lg:px-12 flex flex-col lg:flex-row gap-8 lg:gap-x-10 justify-center lg:justify-around items-center pt-20 pb-12 lg:pt-0">
          <div className="font-extrabold text-center lg:text-left max-w-2xl lg:max-w-none">
            <div>
              <h1 className="text-gray-600 dark:text-gray-200 text-3xl sm:text-4xl md:text-5xl lg:text-6xl">
                Atur Pikiran Anda
              </h1>
              <h1 className="text-[#4FD1C5] text-3xl sm:text-4xl md:text-5xl lg:text-6xl">
                dengan Mudah
              </h1>
            </div>
            <p className="mt-4 max-w-xl text-base sm:text-lg lg:text-xl font-medium text-gray-600 dark:text-gray-300 mx-auto lg:mx-0">
            ...
            <div className="flex flex-col sm:flex-row font-semibold text-base lg:text-lg text-gray-700 dark:text-gray-900 gap-3 sm:gap-x-4 my-8 justify-center lg:justify-start">
              <Link
                href="/sign-up"
          ...
          <div className="rounded-xl overflow-hidden w-full max-w-md lg:max-w-lg flex-shrink-0">
            <Image
              src="/heroImage.png"
              width={450}
              height={450}
        ...
        >
          ...
          <div className="flex-1 rounded-xl overflow-hidden w-full max-w-2xl lg:max-w-none aspect-video lg:aspect-[4/2] relative">
            <Image

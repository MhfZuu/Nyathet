      ...
      {isLoading ? (
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
          ...
          <button
            ...
            className="bg-[#4FD1C5] text-white font-semibold px-6 py-3 rounded-lg hover:bg-[#3fb8ac] transition-colors shadow-md flex items-center gap-2 w-full sm:w-auto justify-center"
          >
            <MdAdd size={24} />
            New Note
          </button>

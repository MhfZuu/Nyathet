      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 sm:p-8 mb-6">
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 mb-6">
          ...
          <div className="text-center sm:text-left">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-700 dark:text-gray-200">
              {user?.fullName || user?.username || 'User'}
            </h2>
            <p className="text-gray-500 dark:text-gray-400 text-base sm:text-lg mt-1">
          ...
          <div className="mt-8">
            ...
            <div className="flex flex-wrap gap-2">
              {Array.from(categories).map((category) => (
                <span
                  key={category}
                  className="px-4 py-2 bg-[#E5F5F6] dark:bg-[#4FD1C5]/20 text-[#4FD1C5] rounded-full font-medium"
                >
                  {category}
                </span>
              ))}
